...
const PostDetail: React.FC<Props> = () => {
  ...
  const shouldShowSubscriptionNotice =
    subtopiaClient && isPaidContent && !isSubscriber
  const shouldShowContent = subtopiaClient || !isPaidContent
  const shouldShowLoading = !subtopiaClient && isPaidContent

  console.log({ subtopiaClient, isPaidContent, isSubscriber })
      ...
      <article>
        ...
        {shouldShowSubscriptionNotice ? (
          <StyledSubscriptionNotice>
            <p>
              👋 Hello, this post is available to BlockPage subscribers. Click
